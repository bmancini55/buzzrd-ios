...
@implementation RemoveFriendCommand

- (id)init
{
    self = [super init];
    if(self) {
        self.completionNotificationName = @"removeFriendComplete";
    }
    return self;
}
...
- (void)main
{
    ...
    NSString *url = [self getAPIUrl:@"/api/me/removeFriend/"];
...
- (id) copyWithZone:(NSZone *)zone {
    RemoveFriendCommand *newOp = [super copyWithZone:zone];
