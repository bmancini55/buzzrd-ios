...
- (void)registerForRemoteNotifications {
    ...
    // iOS7
        ...
        [[UIApplication sharedApplication] registerForRemoteNotificationTypes:UIRemoteNotificationTypeAlert | UIUserNotificationTypeBadge | UIUserNotificationTypeSound];
    }
