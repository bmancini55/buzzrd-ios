...
- (void) configure
{
    ...
    self.messageCountLabel.font = [ThemeManager getPrimaryFontRegular:28.0];
    ...
    self.messageLabel.font = [ThemeManager getPrimaryFontMedium:12.0];
    self.messageLabel.textColor = [ThemeManager getPrimaryColorDark];
    self.messageLabel.translatesAutoresizingMaskIntoConstraints = NO;
    [self.contentView addSubview:self.messageLabel];
    
    self.distanceLabel = [[UILabel alloc] init];
    self.distanceLabel.font = [ThemeManager getPrimaryFontDemiBold:11.0];
...
- (void) updateConstraints
{
    ...
    [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[venue]-6-[distance]" options:NSLayoutFormatAlignAllBaseline metrics:nil views:views]];
    [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[distance]-(>=12)-[msgCount]" options:0 metrics:nil views:views]];
    ...
    [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[title]-(-3)-[venue]" options:NSLayoutFormatAlignAllLeft metrics:nil views:views]];
    ...
    [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[msgCount]-(-12)-[msg]" options:NSLayoutFormatAlignAllRight metrics:nil views:views]];
    [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[msg]-(>=6)-|" options:0 metrics:nil views:views]];
